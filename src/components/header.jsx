...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 dark:border-b-2 dark:border-gray-900 border-gray-200 dark:bg-gray-900 fixed top-0 left-0 right-0 z-50">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 md:p-3 ">
          <Link
            to="/"
